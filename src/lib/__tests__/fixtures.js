...
// Field values are written comma-tight (no space after the delimiter), matching
// how Google Sheets actually exports CSV — a delimiter immediately followed by
// a quote is required for the quote to be recognized as a field-quote at all.
export const WITH_RESULTS = `${SCHEDULE_ONLY}
DRAWRESULTS
